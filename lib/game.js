(function() {
  ...
  Game.prototype.renderShipCount = function() {
    ...
    $("div.shipcount").html("<p><span>"+ this.shipCount +"</span><br> B cells have been infected so far. <br> You have <strong>" + (10 - this.shipCount) + "</strong> B cells left.</p><p>You have killed <strong>"+ (15 - this.asteroids.length) +" </strong> out of 15 viruses</p>");
  };
